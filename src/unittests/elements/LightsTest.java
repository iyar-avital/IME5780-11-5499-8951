...
public class LightsTest {
    ...
    /**
     * Produce a picture of a sphere lighted by all light
     */
    @Test
    public void sphereLisghts() {
        ...
        scene.addLights(
                new SpotLight(new Color(400, 500, 900), new Point3D(-50, 40, -50), new Vector(1, -1, 2), 8, 0.000001, 0.000001),
                new DirectionalLight(new Color(0,400,100),new Vector(12,65,50)),
                new PointLight(new Color(700,200,600), new Point3D(50,50,-50),1,0.001,0.0000001));

        ImageWriter imageWriter = new ImageWriter("sphereLisghts", 150, 150, 500, 500);
    ...
    public void triangleLights() {
        ...
        scene.addLights(
                new SpotLight(new Color(500, 250, 250), new Point3D(10, 10, 70), new Vector(-4, 5, 3), 1, 0.0001, 0.000005),
                new DirectionalLight(new Color(100,50,300),new Vector(10,20,20)),
                new PointLight(new Color(500,700,600), new Point3D(40,40,-10),8,0.001,0.0000001));
